...
//	            throw new PGPException("Encrypted message contains a signed message - not literal data.");
	        	System.out.println(message.toString() + ": Encrypted message contains a signed message.");
	        	// TODO: verify signature
	        } else if (message instanceof PGPSignatureList) { 
	        	System.out.println(message.toString() + ": Encrypted message contains a signature list.");
	        	// TODO: verify signature
	        } else {
//	            throw new PGPException("Message is not a simple encrypted file - type unknown.");
	        	System.out.println(message.toString() + ": Message is not a simple encrypted file - type unknown.");
	        }
        }
